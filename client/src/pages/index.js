...
const index = () => {
    return(
        <div className="h-screen w-full bg-cover " >
            ...
            <Calendar />
            <Pricing />
            <footer class="bg-secondary-color dark:bg-gray-900">
    ...
    <div class="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Deneyim.NET™</a>. All Rights Reserved.
        </span>
